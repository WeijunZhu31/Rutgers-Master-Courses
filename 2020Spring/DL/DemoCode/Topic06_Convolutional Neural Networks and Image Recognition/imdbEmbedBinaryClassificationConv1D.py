...
from keras.layers import Input, Dense, Embedding, Flatten, Conv1D, MaxPool1D, GlobalMaxPool1D
...
#tmp=Flatten()(tmp)
tmp = Conv1D(filters=32, kernel_size=5, activation='relu')(tmp)
#tmp = MaxPool1D(4)(tmp)
tmp = Conv1D(filters=64, kernel_size=5, activation='relu')(tmp)
tmp = MaxPool1D(4)(tmp)
tmp = Conv1D(filters=128, kernel_size=5, activation='relu')(tmp)
#tmp = MaxPool1D(4)(tmp)
#tmp = Conv1D(filters=256, kernel_size=5, activation='relu')(tmp)
#tmp = MaxPool1D(4)(tmp)

tmp = GlobalMaxPool1D()(tmp)
