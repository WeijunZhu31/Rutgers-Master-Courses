...
"""
Conclusion:
    Compared with activation=relu, the results do not change when we set activation=sigmoid. 
    But the accuarcy when epochs=5 is a little better than epochs=20
"""
