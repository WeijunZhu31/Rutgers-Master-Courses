# needed libraries: kknn and ggplot2
...
# Now use the data collected in the trainDat data frame to estimate the
# function. Experiment with different values of k and see the results.
